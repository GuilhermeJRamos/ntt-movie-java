...
public class Movie implements MovieInterface {
    ...
    @ManyToOne()
    private com.guilhermeramos.nttmoviejava.application.entities.genre.Genre Genre;

    @ManyToOne()
    private com.guilhermeramos.nttmoviejava.application.entities.studio.Studio Studio;

    @ManyToOne()
    private com.guilhermeramos.nttmoviejava.application.entities.franchise.Franchise Franchise;
